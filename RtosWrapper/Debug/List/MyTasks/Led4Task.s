...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  C:\projects\micro\RtosWrapper\MyTasks\Led4Task.cpp
//    Command line =
//        -f C:\projects\micro\RtosWrapper\Debug\Obj\MyTasks\Led4Task.o.rsp
//        (C:\projects\micro\RtosWrapper\MyTasks\Led4Task.cpp -lC
...
//        C:\projects\micro\RtosWrapper\Debug\Obj\MyTasks\Led4Task.o.d
//    Locale       =  C
//    List file    =
//        C:\projects\micro\RtosWrapper\Debug\List\MyTasks\Led4Task.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\projects\micro\RtosWrapper\MyTasks\Led4Task.cpp
//    1 #include "Led4Task.hpp"
...
//    2 
        ...
        SECTION `.text`:CODE:NOROOT(2)
          ...
          CFI Function _ZN8Led4Task7ExecuteEv
        THUMB
//    3 void Led4Task::Execute()
//    4 {
_ZN8Led4Task7ExecuteEv:
        PUSH     {R7,LR}        
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
??Execute_1:
...
//    8     led4.Toggle();
        LDR.N    R0,??Execute_0+0x4
          CFI FunCall _ZN3LedILj1073874964ELj5EE6ToggleEv
        BL       _ZN3LedILj1073874964ELj5EE6ToggleEv
        B.N      ??Execute_1    
        DATA
??Execute_0:
        DATA32
...
//   10 }
        ...
        SECTION `.iar_vfe_vtableinfo_ZTV8Led4Task`:DATA:NOALLOC:NOROOT(2)
        SECTION_TYPE SHT_PROGBITS, 0
        SECTION_GROUP _ZTV8Led4Task
        DATA
        DC32    _ZTV8Led4Task
        DC32    3
        DC32    3
...
_ZTV3LedILj1073874964ELj5EE:
        ...
        SECTION_GROUP _ZTV8Led4Task
        DATA
// __absolute void (*const Led4Task::__vtbl[3])()
_ZTV8Led4Task:
        DATA32
        DC32 0x0, _ZTI8Led4Task, _ZN8Led4Task7ExecuteEv
...
_ZTI3LedILj1073874964ELj5EE:
        ...
        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
        SECTION_GROUP _ZTI8Led4Task
        DATA
// __absolute __si_class_type_info const <Typeinfo for Led4Task>
_ZTI8Led4Task:
        DATA32
        DC32 _ZTVN10__cxxabiv120__si_class_type_infoE + 0x8, _ZTS8Led4Task
        DC32 _ZTIN9OsWrapper6ThreadILj256EEE
...
_ZTSN9OsWrapper6ThreadILj256EEE:
        ...
        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
        SECTION_GROUP _ZTS8Led4Task
        DATA
// __absolute char const <Typeinfo name for Led4Task>[10]
_ZTS8Led4Task:
        DATA8
        DC8 "8Led4Task"
        DATA16
